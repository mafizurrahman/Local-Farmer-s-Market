...
<body>
     ...
     <body>
               ...
               <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div class="list-group moblists">
                         ...
                         if (isset($_SESSION['phonenumber'])) {
                              ...
                              echo "<a href='bid_insert.php' class='dropdown-item' style='padding-right:-20px;'>Bid</a>";
                              echo "<a href='display_bids2.php' class='dropdown-item' style='padding-right:-20px;'>Bid Message</a>";

                              // echo "<a href='display_bids.php' class='dropdown-item' style='padding-right:-20px;'>Bid Message</a>";
                               echo "<a href='online_class.php' class='dropdown-item' style='padding-right:-20px;'>Join Online Class</a>";
                               echo "<a href='tour_message2.php' class='dropdown-item' style='padding-right:-20px;'>Farm tour Message</a>";
                              ...
                              // echo "<a href='bid_insert.php' class='list-group-item list-group-item-action ' style='background-color:#292b2c;text-align:center;color:goldenrod'>Bid</a>";
          ...
          <div class="row" style="text-align:center;">
               ...
               <div class="col-md-3 col-sm-12">
                    <a href="CallCenter.php" id="navbar"><i class="fa fa-phone fa-rotate-vertical" aria-hidden="true"></i><label>Contact</label></a>
               </div>
          </div>
          <hr>
               ...
               <div class="container">
                    ...
                    <div class="row">
                         <div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2 text-center">
                              <p><u><a href="https://www.agrocraft.com/">Online Farmers Market</a></u> is a Multitrading Company for farmers ang traders</p>
