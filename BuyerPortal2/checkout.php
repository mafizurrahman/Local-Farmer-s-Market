        ...
        <div class="container mt-2">
            ...
            <form>
                <div class=" float-none float-sm-none float-md-none float-lg-right float-xl-rightcheckout mr-0 p-2 mb-5   " style="border-radius:5%;">
                    <h4 style="font-family: sans-serif"><b>Grand total = USD <?php echo $_SESSION['grandtotal']; ?> </b></h4>
                </div>
                            ...
                            while ($phones = mysqli_fetch_array($run_get_phone)) {
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td data-label="Total (in USD)"><?php echo $subtotal; ?></td>
                                        <?php
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2 text-center">
                    <p><u><a href="">Online Farmers Market</a></u> is a Multitrading Company for farmers ang traders</p>
